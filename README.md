...
# Search the vault (Hybrid + Semantic)
uv run python -m obsidian_mcp.server --search "query term"
uv run python -m obsidian_mcp.server --search "query" --no-semantic # Disable semantic
```
  ...
  "mcp": {
    "obsidian": {
      ...
      "command": [
        ...
        "run",
        "--directory",
        "/home/jishnu/Projects/obsidian-mcp",
        "python",
        "-m",
        "obsidian_mcp.server"
      ],
