...
**The Gap:** There is no mechanism to find notes that discuss the *same concept* using *different words* (e.g., "sleep hygiene" vs. "insomnia protocol") unless they are explicitly linked or share keywords.
